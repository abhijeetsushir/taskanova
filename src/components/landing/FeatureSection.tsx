...
const FeatureCard = ({ title, description, icon: Icon, className }: FeatureCardProps) => {
  return (
    <div className={cn(
      "flex flex-col p-6 bg-background rounded-lg border border-border",
      "hover:border-primary/50 transition-colors duration-300",
      "hover:shadow-lg hover:scale-[1.02] transition-all duration-300",
      className
    )}>
      <div className="p-2 w-12 h-12 rounded-md bg-primary/10 flex items-center justify-center mb-4">
...
export const FeatureSection = () => {
  return (
    <section id="features" className="py-16 md:py-24 px-4 bg-secondary/5">
      <div className="container max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">Navigate your projects with TaskaNova</h2>
